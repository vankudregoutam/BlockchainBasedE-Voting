...
function AdminComponent({account, contractInstance}) {
    ...
    return(
        <div style={{paddingTop: "18px", paddingLeft: "5%", paddingRight: "5%" }}>
            <div className='banner-area'style={{marginBottom: 20, paddingTop: 20}} >
                <h1>WELCOME TO ELECTIONS</h1>
            </div>
            <div >
                ...
                <div>
                    <Card sx={{ width: 400}}>
                        ...
                        <CardActions align="middle">
                            <Button variant="contained" onClick={start_voting}>Start Election</Button>
                        </CardActions>
                    </Card>
                    ...
                    <Card sx={{ maxWidth: 400, marginTop: 5}}>
                        ...
                        <CardActions>
                            <Button variant="contained" onClick={stop_voting}>Stop Election</Button>
                        </CardActions>
                    </Card>
                    ...
                    <Card sx={{ maxWidth: 400, marginTop: 5}}>
                        ...
                        <CardActions>
                            <Button variant="contained" style={{alignContent: "center"}} onClick={get_Winner}>Get Winner</Button>
                        </CardActions>
                    </Card>
